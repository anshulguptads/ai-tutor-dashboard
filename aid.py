...
# -------------- FACULTY DASHBOARD --------------
    ...
    # ---- List of Students at Risk (TRS < 25%) ----
    st.markdown("##### ⚠️ Students at Risk (TRS < 25%)")
    ...
    risk_students = unit_students[unit_students['trs_score'] < 25]
    ...
    for sess in sessions['session_num']:
        ...
        risk = unit_students[(unit_students['trs_score'] < 25) & (unit_students['sessions_attended'] >= sess)]
