...
# -------------- FACULTY DASHBOARD --------------
    ...
    # ---- List of Students at Risk (TRS < 50%) ----
    st.markdown("##### ⚠️ Students at Risk (TRS < 50%)")
    ...
    risk_students = unit_students[unit_students['trs_score'] < 50]
    ...
    for sess in sessions['session_num']:
        ...
        risk = unit_students[(unit_students['trs_score'] < 50) & (unit_students['sessions_attended'] >= sess)]
